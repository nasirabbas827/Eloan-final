...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <a class="navbar-brand ms-3" href="borrower_home.php">Borrower Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto ml-auto"> <!-- Use ms-auto for Bootstrap 5, ml-auto for Bootstrap 4 -->
            <li class="nav-item">
                <a class="nav-link" href="borrower_home.php">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="loan_application.php">Apply Loan</a>
            </li>
            <li class="nav-item">
